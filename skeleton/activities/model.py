...
class ActivityModel(models.Model):
	...
	class ActivityType():
		...
		def is_viable_enum(self, value: int):
			return any(value in item for item in self.TYPES)
		
		def vals_tuple(self, value: int):
			if self.is_viable_enum(value):
				return self.TYPES_DICT[value]
	...
	type = models.IntegerField(choices=ActivityType.TYPES)
