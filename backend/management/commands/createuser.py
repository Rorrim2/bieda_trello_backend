"""
Management utility to create users. By Kamil
"""
import getpass
import os
import sys
    ...
    def handle(self, *args, **options):
        ...
        try:
            if options['interactive']:
                ...
                if PASSWORD_FIELD in user_data and 'DJANGO_USER_PASSWORD' in os.environ:
                    user_data[PASSWORD_FIELD] = os.environ['DJANGO_USER_PASSWORD']
                # Use username from environment variable, if not provided in
                # options.
                if username is None:
                    username = os.environ.get('DJANGO_USER_' + self.UserModel.USERNAME_FIELD.upper())
                if username is None:
                ...
                user_data[self.UserModel.USERNAME_FIELD] = username
                for field_name in self.UserModel.REQUIRED_FIELDS:
                    env_var = 'DJANGO_USER_' + field_name.upper()
